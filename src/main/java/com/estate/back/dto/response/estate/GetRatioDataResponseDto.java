...
public class GetRatioDataResponseDto extends ResponseDto{
    ...
    private GetRatioDataResponseDto (List<GetRatioDateResultSet> resultSets) throws Exception {
    ...
    for (GetRatioDateResultSet resultSet: resultSets) {
    ...
    public static ResponseEntity<GetRatioDataResponseDto> success (List<GetRatioDateResultSet> resultSets) throws Exception {
